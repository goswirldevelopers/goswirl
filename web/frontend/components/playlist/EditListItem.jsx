...
export default function EditListItem(props) {
    ...
    return (
        <>
            { active ? (
                <VideoList title={props.data.name} playlist={playlistType} source={"editPlaylist"} video_id={props.data.video_id} playlist_id={props.data.playlist_id} playlist_data={props.data}/>
            ):(
                <>
